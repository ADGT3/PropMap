...
│   ├── contacts.js          — CRM Contacts CRUD, backed by entity_contacts (V75)
│   ├── finance-api.js       — Financial model CRUD, keyed by deal_id going forward (V75)
│   ├── migrate-to-v75.js    — One-shot structural migration endpoint (V75, admin-only)
