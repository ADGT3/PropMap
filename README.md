...
│   ├── deals.js             — Deals CRUD (V75) — workflow-scoped Kanban cards; auto-cleans orphaned Parcels on DELETE (V75.4d.1)
...
│   ├── create-parcel-from-lookup.js  — V75.4d: creates a Parcel + N Properties + Deal from client-pre-resolved NSW data (admin-only)
