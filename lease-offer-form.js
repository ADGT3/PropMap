...
(function () {
  ...
  async function loadAndShowForm() {
    try {
      ...
      // V78 — Treat 'offer_resubmit_requested' as an editable state alongside 'draft'.
      // Anything past that has been submitted and shows the thank-you screen.
      const editableStatuses = ['draft', 'offer_resubmit_requested'];
      if (!editableStatuses.includes(LOAD_DATA.application.status)) {
